...
public class BTService {
    ...
    synchronized void stop()
    {
        ...
        Toast.makeText(mContext, "Connection Released", Toast.LENGTH_LONG).show();
        ConnectedDevice connectedDevice = (ConnectedDevice) mContext;
        connectedDevice.onBackPressed();
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        ConnectedThread(BluetoothSocket socket) {
            ...
            //dismissed the progressdialog when connection is established
            ...
            while (true) {
                ...
                try {
                    ...
                    try {
                        ...
                        in.putExtra("Msg", Float.valueOf(new String(buffer, 0, bytes)));
